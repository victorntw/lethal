            ...
            <div class="row g-xxl-6 g-5">
                    ...
                    <div class="cmn__dashboard-barwap dashboar-leftbar">
                        <div class="cmn-dashboard-inner radius16 n40border n0-bg py-xxl-10 py-xl-8 py-lg-6 py-5 px-xxl-10 px-xl-4 px-lg-3 px-3">
                            ...
                            <ul class="cmn-dash-menu">
                                ...
                                <li class="mb-xxl-3 mb-2">
                                    <a href="student-subscribtions.html" class="cmn-dashitem active d-flex gap-2 align-items-center fw_500 n500-color">
                ...
                <div class="col-lg-9">
                    <div class="cmn__dadhboardbody">
                        <div class="radius16 n40border py-xxl-8 py-4 px-xxl-8 px-4">
                            <div class="row g-xxl-6 g-4 justify-content-between">
                                <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                    <div class="wow fadeInUp">
                                        <span class="n500-color d-block mb-xxl-2 mb-1">
                                            Active Plan
                                        </span>
                                        <h5 class="n700-color">
                                            Basic
                            ...
                            <div class="used-plan tb-n40dash bb-n40dash pt-xxl-8 pt-6 mt-xxl-8 mt-6 pb-xxl-8 pb-6 mb-xxl-8 mb-6">
                                <div class="d-flex align-items-center justify-content-between mb-xxl-4 mb-2">
                            ...
                            <div class="auto-renewalwrap bb-n40dash pb-xxl-8 pb-6">
                                <div class="sec__pra auto-renews n0-color">
                                    <div class="d-flex mb-4 align-items-center gap-xxl-4 gap-2" id="js-pricing-switch">
                                        <label class="switch">
                                           <input type="checkbox" checked="checked">
                                           <span class="slider"></span>
                                        </label>
                                        <span class="fw_600 n700-color">
                                            Auto Renewal
                                        </span>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center flex-wrap justify-content-between gap-2">
                                    <p class="n500-color max500">
                                        Your plan will automatically renew on: 02/10/2024. Payment Amount: USD250
                                    </p>
                                    <div class="d-flex align-items-center gap-xxl-6 gap-4">
                                        <button type="button" class="cmn-btn d-none d-sm-block second-alt n700-color gap-2 d-flex align-items-center radius30 py-2 py-xxl-3 px-xxl-6 px-5">
                                            <span>
                                                Calcel Plan
                                            </span>
                                        </button>
                            ...
                            <ul class="renewal-list d-flex flex-wrap pt-xxl-8 pt-6">
                                <li class="d-flex align-items-center gap-xxl-2 gap-1 n500-color fw_500">
                                    <i class="ti ti-discount-check s2-color fs-22"></i>
