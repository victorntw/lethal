            ...
            <div class="row g-xxl-6 g-5">
                    ...
                    <div class="cmn__dashboard-barwap dashboar-leftbar">
                        <div class="cmn-dashboard-inner radius16 n40border n0-bg py-xxl-10 py-xl-8 py-lg-6 py-5 px-xxl-10 px-xl-4 px-lg-3 px-3">
                            ...
                            <ul class="cmn-dash-menu">
                                ...
                                <li class="mb-xxl-3 mb-2">
                                    <a href="instructor-editprofile.html" class="cmn-dashitem active d-flex gap-2 align-items-center fw_500 n500-color">
                ...
                <div class="col-lg-9">
                    <div class="cmn__dadhboardbody">
                        <div class="radius16 n30-border py-xxl-10 py-lg-6 py-4 px-xxl-10 px-lg-6 px-4 mb-xxl-6 mb-5">
                            ...
                            <div class="d-flex align-items-center gap-xxl-10 gap-xl-8 gal-lg-6 gap-4 bb-n40dash pb-xxl-6 pb-5 mb-xxl-6 mb-5">
                                <img src="assets/images/banner/miles.png" alt="img" class="cmn__icon115 radius100">
                                ...
                                <div class="row g-xxl-6 g-5">
                                    <div class="col-lg-6 col-md-6">
                                        <div class="form-cmn">
                                            ...
                                            <input type="text" placeholder="Dr Floyd" class="n10-bg radius16" id="kath">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6">
                                        <div class="form-cmn">
                                            <label for="murphy" class="mb-xxl-4 mb-3 fs-six fw_500 n500-color">Last Name</label>
                                            <input type="text" placeholder="Miles" class="n10-bg radius16" id="murphy">
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-cmn">
                                            <label for="esmail" class="mb-xxl-4 mb-3 fs-six fw_500 n500-color">Last Name</label>
                                            <input type="email" placeholder="info@email.com " class="n10-bg radius16" id="esmail">
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-cmn">
                        ...
                        <div class="billing-box n0-bg radius16 cus-border border py-xxl-8 py-xl-6 py-4 px-xxl-8 px-xl-6 px-4 mb-xxl-6 mb-5">
                            ...
                            <form action="#0" class="writere-v1">
                                <div class="row g-xxl-6 g-5">
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <div class="form-cmn">
                                            <label for="adds2" class="fs-six fw_500 n700-color mb-xxl-4 mb-3">Address 1</label>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-cmn">
                                            <label for="cardn" class="fs-six fw_500 n700-color mb-xxl-4 mb-3">Zip Code</label>
