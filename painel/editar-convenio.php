...
<head>
    ...
    <title>Painel SEDF - Editar Convênio</title>
                                ...
                                <form method="POST" enctype="multipart/form-data">
                                    <div class="form-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <input class="form-control" type="text" name="link" value="<?php if(isset($puxaConvenio->link) && !empty($puxaConvenio->link)){ echo $puxaConvenio->link;}?>" />
                                            </div>
