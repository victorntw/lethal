...
<head>
    ...
    <title>Painel SEDF - Editar Faq</title>
...
<body>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <label class="mr-sm-2" for="">Serviço</label>
                                                   <select name="id_servico" class="form-control" id="">
                                                       <?php foreach($puxaServicos as $servico){?>
                                                       <option value="<?php echo $servico->id;?>" <?php if(isset($descFaq->id_servico) && $descFaq->id_servico == $servico->id){ echo "selected";}?>><?php echo $servico->titulo;?></option>
                                                       <?php }?>
                                                   </select>
                                                </div>
                                            </div>
    ...
    <?php if(isset($descFaq->foto) && !empty($descFaq->foto)){?>
    <div class="col-md-2 col-sm-12">
    <label  class="col-form-label">Foto</label>
     <img src="../img/<?php echo $descFaq->foto;?>" alt="">
    </div>
    <?php }?>
