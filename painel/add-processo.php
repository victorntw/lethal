...
<head>
    ...
    <title>Painel SEDF - Adicionar Processo</title>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Adicionar Processo</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="." class="text-muted">Home</a></li>
                                    <li class="breadcrumb-item text-muted active" aria-current="page"><a href="processo" class="text-muted">Processos</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form id="formRepresentantes" method="POST" enctype="multipart/form-data">
                                    <div class="form-body">
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                ...
                                                <div class="input-group" id="representanteGroup">
                                                    <select type="text" name="representante1" class="form-control">
                                                        ...
                                                        <option value="<?= $infor_rp->id; ?>"><?php echo $infor_rp->representante1; ?></option>
                                                        <?php endforeach ?>
                                                    </select>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-6 col-sm-12">
                                                ...
                                                <textarea name="andamento" class="form-control" cols="30" rows="3"></textarea>
                                            </div>
                                    ...
                                    <input type="hidden" name="acao" value="addProcesso">
                                </form>
                            </div>
                        </div>
                    </div>
