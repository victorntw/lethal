...
<head>
    ...
    <title>Painel SEDF - Editar Blog</title>
                            ...
                            <div class="card-body">
                                <form method="POST" enctype="multipart/form-data">
                                    <div class="form-body">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-2 col-sm-12">
                                                ...
                                                <select name="ativo" class="form-control" id="">
                                                    <option value="S"
                                                        <?php if(isset($editaBlog->ativo) && $editaBlog->ativo == 'S'){ echo "selected";}?>>
                                                        Sim</option>
                                                    <option value="N"
                                                        <?php if(isset($editaBlog->ativo) && $editaBlog->ativo == 'N'){ echo "selected";}?>>
                                                        Não</option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <label class="col-form-label">Video Thumb</label>
                                                <input class="form-control" type="file" name="thumb" value="">
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-12 col-sm-12">
                                                ...
                                                <input class="form-control" type="text" name="url_amigavel"
                                    ...
                                    <input type="hidden" name="id"
                                        value="<?php if(isset($editaBlog->id) && !empty($editaBlog->id)){ echo $editaBlog->id;}?>">
                                    <input type="hidden" name="foto_Atual"
                                        value="<?php if(isset($editaBlog->foto) && !empty($editaBlog->foto)){ echo $editaBlog->foto;}?>">
                                </form>
                            </div>
                        </div>
                    </div>
