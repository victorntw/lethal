...
<head>
    ...
    <title>Painel SEDF - Editar Banner</title>
...
<body>
    ...
    <label  class="col-form-label">Breve</label>
     <textarea name="breve" class="ckeditor" id="ckeditor" cols="30" rows="10"><?php if(isset($editarBanner->breve) && !empty($editarBanner->breve)){ echo $editarBanner->breve;}?></textarea>
    </div>
                                        ...
                                        <div class="row">
                                           <div class="col-md-3">
                                            ...
                                            <div class="col-md-3" id="temIcone" style="<?php if(isset($editarBanner->tem_video) && $editarBanner->tem_video == 'N'){ echo "display: none;";}?>">
                                                <div class="form-group">
                                                <label class="mr-sm-2" for="">Icone do Player</label>
                                                <input type="file" name="icone" class="form-control">
                                                </div>
                                                <?php if(isset($editarBanner->icone) && !empty($editarBanner->icone)){ ?>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <img src="../img/<?php echo $editarBanner->icone;?>"  width="100">
                                                        </div>
                                                    </div>
                                                <?php }?>
                                            </div>
