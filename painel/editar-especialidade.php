...
<head>
    ...
    <title>Painel SEDF - Editar Especialidade</title>
...
<body>
    ...
    <?php foreach($puxaCategorias as $categoria){?>
		<option value="<?php echo $categoria->id;?>" <?php if(isset($editaEspecialidade->id_categoria) && $editaEspecialidade->id_categoria == $categoria->id){ echo "selected";}?>><?php echo $categoria->nome;?></option>
        <?php }?>
	</select>   
    </div>
   ...
   <div class="form-group row">
    ...
    <label  class="col-form-label">Descrição Imagem</label>
     <input class="form-control" type="text" name="descricao_imagem" value="<?php if(isset($editaEspecialidade->descricao_imagem) && !empty($editaEspecialidade->descricao_imagem)){ echo $editaEspecialidade->descricao_imagem;}?>" />
    </div>
   </div>
...
<div class="col-md-12">	   
   ...
   <div class="form-group row">
    ...
    <label  class="col-form-label">Meta Title</label>
     <input class="form-control" type="text" name="meta_title" value="<?php if(isset($editaEspecialidade->meta_title) && !empty($editaEspecialidade->meta_title)){ echo $editaEspecialidade->meta_title;}?>" />
    </div>   
   </div>
   <div class="form-group row">
    <div class="col-md-12 col-sm-12">
    <label  class="col-form-label">Meta Keywords</label>
     <input class="form-control" type="text" name="meta_keywords" value="<?php if(isset($editaEspecialidade->meta_keywords) && !empty($editaEspecialidade->meta_keywords)){ echo $editaEspecialidade->meta_keywords;}?>" />
    </div>   
   </div>
   <div class="form-group row">
    <div class="col-md-12 col-sm-12">
    <label  class="col-form-label">Meta Description</label>
	<textarea name="meta_description" class="form-control" id="" cols="30" rows="10"><?php if(isset($editaEspecialidade->meta_description) && !empty($editaEspecialidade->meta_description)){ echo $editaEspecialidade->meta_description;}?></textarea> 
    </div>   
   </div>
                                    </div>
