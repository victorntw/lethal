            ...
            <div class="row g-xxl-6 g-5">
                    ...
                    <div class="cmn__dashboard-barwap dashboar-leftbar">
                        <div class="cmn-dashboard-inner radius16 n40border n0-bg py-xxl-10 py-xl-8 py-lg-6 py-5 px-xxl-10 px-xl-4 px-lg-3 px-3">
                            ...
                            <ul class="cmn-dash-menu">
                                ...
                                <li class="mb-xxl-3 mb-2">
                                    <a href="student-whislist.html" class="cmn-dashitem active d-flex gap-2 align-items-center fw_500 n500-color">
                ...
                <div class="col-lg-9">
                    <div class="cmn__dadhboardbody">
                        <div class="radius16 n40border n0-bg py-xxl-8 py-xl-6 py-lg-5 py-4 px-xxl-6 px-xl-4 px-lg-3 px-3">
                            <div class="d-flex flex-wrap gap-3 newest__filter align-items-center justify-content-between bb-n40dash pb-xxl6 pb-5 mb-xxl-6 mb-6">
                            ...
                            <div class="row g-xxl-6 g-5">
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="explore__item n30-border n0-bg radius16 p-xxl-4 p-xl-3 p-2">
                                        <div class="thumb over w-100 position-relative">
                                            <img src="assets/images/common/ex1.png" class="w-100 radius16 mimg " alt="img">
                                            <div class="d-flex marketing-posi align-items-center justify-content-between mb-2 mb-xl-6">
                                                <span class="srgba rounded fw_600 py-1 py-xl-2 px-3 px-xl-4">
                                                    Beginner
                                                </span>
                                        ...
                                        <div class="content pt-4 pt-lg-5 pt-xl-6 pt-xxl-7 px-1 px-xl-2 px-xxl-4 pb-2 pb-lg-2 pb-xl-3 pb-xxl-4">
                                            <h5 class="bb-704 pb-5 pb-xxl-6 mb-5 mb-xxl-6 fw_600">
                                                <a href="courses-details2.html">
                                                    Introduction to Digital Marketing Course
                                                </a>
                                            </h5>
                                            <div class="d-flex align-items-center justify-content-between mb-3 mb-xl-3">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between">
                                                <a href="courses-details2.html" class="d-flex ser-see align-items-center gap-1 gap-xl-2">
                                                    <span class="n700-color fs-six fw_600">
                                                        Enroll Now
                                                    </span>
                                                    <i class="ti ti-arrow-up-right n700-color fs-six"></i>
                                                </a>
                                                <div class="doll">
                                                    <h5 class="s2-color fw_600">
                                                       $299
                                                    </h5>
                                                </div>
                                            </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="explore__item n30-border n0-bg radius16 p-xxl-4 p-xl-3 p-2">
                                        <div class="thumb over w-100 position-relative">
                                            <img src="assets/images/common/ex2.png" class="w-100 radius16 mimg " alt="img">
                                            <div class="d-flex marketing-posi align-items-center justify-content-between mb-2 mb-xl-6">
                                                <span class="srgba rounded fw_600 py-1 py-xl-2 px-3 px-xl-4">
                                                    Beginner
                                                </span>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="explore__item n30-border n0-bg radius16 p-xxl-4 p-xl-3 p-2">
                                        <div class="thumb over w-100 position-relative">
                                            <img src="assets/images/common/ex3.png" class="w-100 radius16 mimg " alt="img">
                                            <div class="d-flex marketing-posi align-items-center justify-content-between mb-2 mb-xl-6">
                                                <span class="srgba rounded fw_600 py-1 py-xl-2 px-3 px-xl-4">
                                                    Beginner
                                                </span>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="explore__item n30-border n0-bg radius16 p-xxl-4 p-xl-3 p-2">
                                        <div class="thumb over w-100 position-relative">
                                            <img src="assets/images/common/ex4.png" class="w-100 radius16 mimg " alt="img">
                                            <div class="d-flex marketing-posi align-items-center justify-content-between mb-2 mb-xl-6">
                                                <span class="srgba rounded fw_600 py-1 py-xl-2 px-3 px-xl-4">
                                                    Beginner
                                                </span>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="explore__item n30-border n0-bg radius16 p-xxl-4 p-xl-3 p-2">
                                        <div class="thumb over w-100 position-relative">
                                            <img src="assets/images/common/ex5.png" class="w-100 radius16 mimg " alt="img">
                                            <div class="d-flex marketing-posi align-items-center justify-content-between mb-2 mb-xl-6">
                                                <span class="srgba rounded fw_600 py-1 py-xl-2 px-3 px-xl-4">
                                                    Beginner
                                                </span>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="explore__item n30-border n0-bg radius16 p-xxl-4 p-xl-3 p-2">
                                        <div class="thumb over w-100 position-relative">
                                            <img src="assets/images/common/ex6.png" class="w-100 radius16 mimg " alt="img">
                                            <div class="d-flex marketing-posi align-items-center justify-content-between mb-2 mb-xl-6">
                                                <span class="srgba rounded fw_600 py-1 py-xl-2 px-3 px-xl-4">
                                                    Beginner
                                                </span>
