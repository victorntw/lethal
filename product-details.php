...
<body class="n20-bg">
    ...
    <!-- courses community start -->
    <section class="community-section pt-6 mb-20 overflow-visible">
        <div class="container container1600">
            <div class="courses-detailswrap product-details-shape position-relative">
                <div class="thumb-courses position-relative">
                    <img src="assets/images/banner/product-details.png" alt="img" class="w-100 radius32 mimg">
                </div>
            </div>
        </div>
        <div class="product-profile-body cmn__rightclick position-relative">
            <div class="container">
                <button type="button" class="clickhere-active mt-0 mt-sm-10">
                    <i class="ti ti-adjustments-horizontal fs-four fw-400"></i>
                    Sidebar Toggle
                </button>
                <div class="row g-6">
                    <div class="col-lg-8">
                        <div class="pro-detailsleft mt-10">
                            <!--porduct details left-->
                            <div class="n0-bg radius16 cus-border border py-xxl-8 py-xl-6 py-4 px-xxl-8 px-xl-6 px-4 mb-6">
                               <div class="d-grid justify-content-center m-auto text-md-start d-md-flex align-items-center gap-xxl-10 gap-xl-8 gap-lg-6 gap-5 bb-n50dash pb-xxl-8 pb-7 mb-xxl-8 mb-7">
                                    <img src="assets/images/gallery/office-desk.png" alt="img">
                                    <div class="cont">
                                        <h4 class="n700-color d-flex flex-wrap align-items-center mb-4">
                                            Office & Desk Chairs <span class="fs-seven n500-color fw_400">(Gift Card)</span>
                                        </h4>
                                        <div class="d-flex align-items-center gap-2 mb-4">
                                            <i class="ti ti-star-filled s1-color fs20"></i>
                                            <i class="ti ti-star-filled s1-color fs20"></i>
                                            <i class="ti ti-star-filled s1-color fs20"></i>
                                            <i class="ti ti-star-filled s1-color fs20"></i>
                                            <i class="ti ti-star-half-filled s1-color fs20"></i>
                                        </div>
                                        <p class="n500-color">
                            ...
                            <div class="average-review-v1 cus-border border box-shadow4 py-xxl-10 py-xl-8 py-lg-6 py-5 px-xxl-10 px-xl-8 px-lg-6 px-5 n0-bg radius16 mb-xxl-10 mb-xl-8 mb-6">
                                ...
                                <div class="comments__box radius16 mb-xxl-8 mb-6 cus-border border py-xl-6 py-5 px-xl-6 px-5 n20-bg">
                                    ...
                                    <div class="author__attach bb-n50dash pb-xxl-6 pb-5 mb-5 mb-xxl-6 mb-5 gap-xxl-6 gap-xl-5 gap-3 d-flex align-items-center">
                                        <div class="author">
                                            <img src="assets/images/common/coms4.png" class="radius100" alt="img">
                                        </div>
                                        <div class="cont__box">
                                            <span class="fs20 fw_500 n700-color d-block mb-0">
                                                Arlene McCoy
                    ...
                    <div class="col-lg-4">
                        <div class="course-probiowrap-right cmn-leftclickbody pro-rightbar">
                            <div class="active-userbox n0-bg cus-border border radius16 py-xxl-8 py-xxl-6 py-4 px-xl-6 px-4 mb-xxl-6 mb-5">
                                <span class="n700-color fs-six fw_500 mb-xxl-6 mb-4 d-block">
                                    Price
                                </span>
                                <div class="d-flex gap-2 mb-xxl-10 mb-8">
                                    <div class="d-flex gap-3 align-items-center">
                                        <i class="ti ti-tag fs-five fw_400"></i>
                                        <span class="n700-color fw-400">
                                            From
                                        </span>
                                        <span class="fs-four fw_600 d-block n700-color">
                                            $455
                                        </span>
                                    </div>
                                    <i class="ti ti-info-circle n500-color"></i>
                                </div>
                                <div class="d-flex align-items-center justify-content-between bb-n50dash pb-xxl-8 pb-xl-6 pb-4 mb-xxl-4">
                                    <span class="fs20 fw_400 n500-color">
                                        Purchase Quantity
                                    </span>
                                ...
                                <div class="d-flex align-items-center justify-content-between tb-n50dash mt-4 pt-4">
                                    <span class="n700-color">
                                        Total
                                    </span>
                                    <span class="fw_500 n700-color">
                                ...
                                <div class="box pt-xxl-6 pt-3">
                                    <a href="#0" class="cmn-btn mt-6 mb-5 fw_600 justify-content-center d-flex align-items-center gap-2 py-3 px-3 n700-color">
                                        <span>
                                            Buy Now
                                        </span>
                                        <i class="ti ti-arrow-up-right fs-six"></i>
